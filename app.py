...
# LOADING DATA
vocab = pickle.load(open('saved_vocabulary/vocab_flickr.file', 'rb'))
...
def get_caption_model():
    ...
    try:
        caption_model.load_weights('saved_models/image_captioning_flickr_weights.h5')
    except FileNotFoundError:
        caption_model.load_weights('Image-Captioning/saved_models/image_captioning_flickr_weights.h5')
